...
namespace Test1.BookStore.Migrations
{
    ...
    [Migration("20260305163820_ReplaceUploadedExcelRowWithExcelImportBatch")]
    partial class ReplaceUploadedExcelRowWithExcelImportBatch
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Test1.BookStore.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Test1.BookStore.ExcelData.ExcelDataRow", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppExcelDataRows", (string)null);
                });

            modelBuilder.Entity("Test1.BookStore.ExcelData.ExcelImportBatch", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("UploadTimeUtc");

                    b.HasIndex("UploadedByUserId");

                    b.ToTable("AppExcelImportBatches", (string)null);
                });
            ...
            modelBuilder.Entity("Volo.Abp.Identity.IdentityUser", b =>
                {
                    ...
                    b.Property<string>("Secodndary Phone")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
            ...
            modelBuilder.Entity("Test1.BookStore.ExcelData.ExcelDataRow", b =>
                {
                    b.HasOne("Test1.BookStore.ExcelData.ExcelImportBatch", "Batch")
                        .WithMany("Rows")
