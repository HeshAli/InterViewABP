...
namespace Test1.BookStore.EntityFrameworkCore.Applications.ExcelData;

[Collection(BookStoreTestConsts.CollectionDefinitionName)]
public class EfCoreExcelDataAppService_SmokeTests : BookStoreEntityFrameworkCoreTestBase
{
